...
const Tabs = () => {
    ...
    const tabContent = {
        ...
        Contact: {
            title: " We’re here to answer your  questions and welcome you.",

            content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Integer nec odio. Praesent libero. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi."
        }
    };
    ...
    return (
        <div className="tab">
            {/* Tab Buttons */}
            <ul className="font-Roboto font-medium flex gap-4 border-b border-color-red  ">
                {["About", "Experience", "Contact"].map((tab) => (
                    <li
                        key={tab}
                        onClick={() => handleTabClick(tab)}
                        className={`py-1.5 px-6 cursor-pointer leading-6 text-sm transition-colors ${activeTab === tab
                            ? "background-button  text-white" // Active tab styles
                            : " text-black" // Inactive tab styles
                            }`}
                    >
                        {tab}
                    </li>
