...
const Tabs = () => {
    ...
    const tabContent = {
        ...
        Contact: {
            title: " We’re here to answer your valuable questions and welcome you.",
    ...
    return (
        <div className="tab">
            {/* Tab Buttons */}
            <ul className="flex gap-4 border-b border-color-red  ">
            ...
            {/* Tab Content */}
            <div >
                <h2 className="text-4xl py-4"> {tabContent[activeTab].title}</h2>
                <p className="text-sm text-gray-500">{tabContent[activeTab].content}</p>
                <div className="flex py-4 gap-4 lg:gap-8">
                    <button className="text-black text-sm uppercase px-4  lg:px-6 lg:py-2 font-bold bg-tableyellow ">About more</button>
                    <div className="flex gap-2 items-center py-4">
                        ...
                        <span className="font-bold text-sm ">+88 3426 739 485</span>
